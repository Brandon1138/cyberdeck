  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        executor: { type: "string", enum: ["host", "orbstack-container"] },
        executionProfile: { type: "string", maxLength: 64 },
