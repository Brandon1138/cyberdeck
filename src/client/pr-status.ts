...
/** Tone names must stay a subset of the fleet palette keys. */
export type PullRequestTone = "green" | "dim" | "purple" | "gray" | "red";
...
const GLYPHS: Readonly<Record<PullRequestState, PullRequestGlyph>> = {
  open: { glyph: "●", tone: "green" },
  draft: { glyph: "○", tone: "dim" },
  merged: { glyph: "◆", tone: "purple" },
  closed: { glyph: "⊘", tone: "gray" },
  "checks-failing": { glyph: "✗", tone: "red" },
};
